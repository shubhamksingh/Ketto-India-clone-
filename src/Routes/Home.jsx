  ...
  return (
    <Box w={'100%'} /*border='1px solid black'*/ >
      <div className={styles.banner} >
        <div className={styles.inside_banner}>
          ...
          <div className={styles.inside_banner1}>
            <div>
              <h3>0%</h3> <span>PLATFORM FEE</span>
            </div>
            <div>
              <h3>55 Lakh+</h3> <span>DONORS</span>
            </div>
            <div>
              <h3>2 Lakh+</h3> <span>FUNDRAISERS</span>
            </div>
          </div>

          <div className={styles.inside_banner2}>
            <p>
              Ketto’s <b>0% Platform fees </b>ensures maximum funds for you
            </p>
            <Button
              variant="solid"
              colorScheme="teal"
      ...
      <Box w="50%" m="auto" mb="3rem">
        <Box as="h2" fontSize="40px" p="2rem" mt="1rem" fontWeight="bold">
        ...
        >
          <Image
            src="https://ketto.gumlet.io/assets/images/homepage/sac-separator.png?w=100&dpr=1.1"
            h="20rem"
          />
          <Box
            display="flex"
          ...
          >
            ...
            >
              <h3
                style={{ color: "teal", fontSize: "26px", fontWeight: "bold" }}
              >
          ...
          <Box w='20rem' display={{base:'none' , lg:'flex'}}>
          <video display={{base:'none'}} style={{width:'200px', height:'500px', padding:'1rem'}} src='https://d1vdjc70h9nzd9.cloudfront.net/videos/screen_recording.mp4'/>
          </Box>
        </Box>
      </Box>
      {/* </Container> */}
